...
{#if $isCartDrawerOpen}
  ...
  >
    <div
      ...
      class="fixed inset-0 bg-light/50 backdrop-blur-sm transition-opacity"
    />
      ...
      <div class="absolute inset-0 overflow-hidden">
        ...
        >
          <div
            ...
            class="pointer-events-auto w-screen max-w-lg max-h-screen bg-light"
          >
                    ...
                    >
                      {#each $cart.lines?.nodes as item}
                        <li class="grid py-8 grid-cols-12 gap-3">
                          <div
                            class="overflow-hidden col-span-3 lg:col-span-2"
                          >
                            <ShopifyImage
