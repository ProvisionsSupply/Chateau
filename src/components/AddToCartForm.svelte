<script lang="ts">
  ...
  $: noQuantityLeft =
    variantInCart && !variantAvailableForSale && variantQuantityAvailable <= variantInCart?.quantity;
...
<form id='variant-{index}' class="form-variants {formClass} hidden [&.active]:block" on:submit|preventDefault={(e) => addToCart(e)}>
